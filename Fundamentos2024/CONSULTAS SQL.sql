...
--1) MOSTRAR EL NUMERO DE EMPLEADOS Y SU MAXIMO SALARIO POR CADA DEPARTAMENTO

--2) MOSTRAR EL NUMERO DE DOCTORES POR CADA HOSPITAL
--TENEMOS UNA TABLA LLAMADA HOSPITAL
--TENEMOS UNA TABLA LLAMADA DOCTOR

ALEJANDRO L --> NECESITO QUE ME MUESTRES TU PANTALLA